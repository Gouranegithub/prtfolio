...
%-----------------img-----------------------------------------
\hspace{8cm} % Adjust the %horizontal space as needed
\includegraphics[width=0.19\textwidth]{./pic}
%-----------------img-----------------------------------------
...
\geometry{left=0.7cm, top=.8cm, right=0.7cm, bottom=1.8cm, footskip=.5cm}
...
\name{GOURANE}{Abdellah}
% \position{Software Architect{\enskip\cdotp\enskip}Security Expert}
\address{}

\mobile{+212701207503}
\email{gouraneabdellah@gmail.com}
%\dateofbirth{January 1st, 1970}
% \homepage{} 
\github{Gouranegithub}
\linkedin{abdellah-gourane}
% \gitlab{gitlab-id}
% \stackoverflow{SO-id}{SO-name}
% \twitter{@twit}
% \skype{skype-id}
% \reddit{reddit-id}
% \medium{oussamahamdani1718}
% \kaggle{kaggle-id}
